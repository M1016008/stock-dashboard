...
function nullOutcome(
  ...
  return {
    ...
    snapshotBasis: event.snapshotBasis,
    spreadDiagnosticDate: event.spreadDiagnosticDate,
    spreadExpansionPass: event.spreadExpansionPass,
    spreadExpansionAvailable: event.spreadExpansionAvailable,
    bullishMaOrder: event.bullishMaOrder,
    maSpreadPct: event.maSpreadPct,
    maSpreadSlope: event.maSpreadSlope,
    maSpreadExpansionRatio: event.maSpreadExpansionRatio,
