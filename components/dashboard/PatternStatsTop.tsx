    ...
    <Card>
      ...
      {rows.length === 0 ? (
        ...
        <div className="divide-y divide-[var(--color-border-soft)]">
          <div className="grid grid-cols-[1fr_70px_104px] gap-3 px-2 pb-3 text-[12px] font-bold text-[var(--color-text-tertiary)]">
          ...
          {rows.map(r => {
            ...
            return (
              <Link
                ...
                className="grid grid-cols-[1fr_70px_104px] items-center gap-3 rounded-[8px] px-2 py-2.5 text-[14px] font-medium hover:bg-[var(--color-surface-subtle)]"
              >
                <span className="tabular-nums font-semibold">{r.pattern_code}</span>
