...
assert.match(mlJob, /earliestShortLabelDate/)
...
assert.match(mlRlPolicy, /ML_RL_POLICY_CACHE_PAGE_DATES \?\? 5/)
...
assert.match(mlPhysicsStatus, /ML_PHYSICS_STATUS_CACHE_PAGE_DATES \?\? 5/)
assert.match(mlPhysicsStatus, /\.\.\.args, STATUS_CACHE_PAGE_DATES/)
...
assert.match(usWeeklyRunner, /audited all_paged baseline proof is missing/)
