...
assert.match(updater, /US_DAILY_RETRY_PRICE_COVERAGE_PCT', minimumCoveragePct/)
...
assert.match(updater, /\['analog_index_price_date', afterOhlcv\]/)
...
assert.match(usAutoUpdateInstaller, /US_DAILY_RETRY_PRICE_COVERAGE_PCT=.*:-95/)
...
const headerNavigation = read('components/layout/navigation.ts')
assert.match(headerNavigation, /\/us\/analysis\/ml-lens/)
assert.match(headerNavigation, /\/us\/analysis\/transitions/)
assert.match(headerNavigation, /\/us\/analysis\/backtest/)
